...
public class FurtherEnemiesProtocolBehaviour implements ProtocolBehaviour {
	...
	public Optional<Comparator<ScannedCoordinate>> getComparator() {
		return Optional.of(Comparator.comparing(ScannedCoordinate::getDistance).reversed());
	}
